...
We found the best runtime-accuracy trade-off using the euler integrator from Schöbi et al. (2021) and recommend using this integrator with the convolution-based model: `'euler_fx_cmc_ei_v1.m'` 
