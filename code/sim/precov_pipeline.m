...
presults = 'C:\projects\dcm_ei\results\p50\parameter_recovery_hc_grandmean\estimated\sim_dcms';
...
presults = 'C:\projects\dcm_ei\results\mmn\parameter_recovery_hc_grandmean\estimated\sim_dcms';
precov_run_headmodel(pdata);
precov_sim_data_cluster(pdcms, pdata, presults, noise);
...
presults = 'C:\projects\dcm_ei\results\p300_napls\parameter_recovery_hc_grandmean\estimated\sim_dcms';
precov_run_headmodel(pdata);
precov_sim_data_cluster(pdcms, pdata, presults, noise);
...
pplots = 'C:\projects\dcm_ei\results\mmn\parameter_recovery_hc_grandmean\estimated\plots';
precov_plot_results(presults, pplots, which_params, param_names)
