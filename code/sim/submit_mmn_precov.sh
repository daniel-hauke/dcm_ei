...
echo "Execute command: precov_reinvert_cluster(${SGE_TASK_ID},'MMN')" 
matlab -nodisplay -nodesktop -nojvm -nosplash -singleCompThread -r "precov_reinvert_cluster(${SGE_TASK_ID},'MMN')" 
