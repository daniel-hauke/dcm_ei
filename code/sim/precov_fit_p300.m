...
switch uid(1: end-1)
    ...
    otherwise
        ...
        presults = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/p300/parameter_recovery/dcms';
        pdata = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/p300/parameter_recovery/data';
