...
#$ -N p300_mrec
#$ -t 1-1
#$ -o /SAN/intelsys/Psycho_Pheno2/dcm_ei/results/p300/model_recovery/logfiles
#$ -e /SAN/intelsys/Psycho_Pheno2/dcm_ei/results/p300/model_recovery/errorfiles
...
matlab -nodisplay -nodesktop -nojvm -nosplash -singleCompThread -r "mrecov_reinvert_cluster(${SGE_TASK_ID},'P300')" 
