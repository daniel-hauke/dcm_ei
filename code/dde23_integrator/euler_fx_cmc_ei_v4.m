function [f,J,D] = euler_fx_cmc_ei_v1(x,u,P,M,xtau)
...
%E  = [1 1/8 1/4 1/2]*300;             % extrinsic (forward and backward)  
G  = [4 4 4 2 2 4 4 2 1 4 4 4]*200;   % intrinsic connections 
%G  = [1 1 1 1/2 1/2 1 1 1/2 1/4 1 1 1];   % intrinsic connections 
%G  = [8 8 4 2 2 8 4 8 8 4 8 4]*135;
T  = [2 2 16 28];                     % synaptic time constants: or [2 2 10 20] in Shaw (2017)
%T  = [10 10 20 10];                     % synaptic time constants: or [2 2 10 20] in Shaw (2017) 
