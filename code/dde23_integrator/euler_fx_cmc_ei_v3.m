function [f,J,D] = euler_fx_cmc_ei_v3(x,u,P,M,xtau)
...
%--------------------------------------------------------------------------
E  = [1 1/8 1/4 1/2]*(200*exp(P.syn_ext)); % extrinsic (forward and backward) 
%E  = [1 1/8 1/4 1/2]*400;
%E  = [1 1/8 1/4 1/2]*1000;
%E  = [1 1/8 1/4 1/2]*1500;
G  = [4 4 4 4 1 4 4 2 1 4 4 4]*(200*exp(P.syn_int));   % intrinsic connections 
% G  = [16 4 4 1 2 48 24 2 16 20 16 4]*200;   % DH experimenting
% G  = [48 16 16 4 8 48 24 16 24 48 24 8]*200; 
% G  = [4 4 4 4 1 4 4 2 1 4 4 4]*300; % produces oscillations and longer ERPs
% G  = [4 4 4 4 1 4 4 2 1 4 4 4]*300; 
...
if isfield(M,'cmcj')
    ...
    j = [6 3 10 11 7 1 2 4 5 8 9 12];                      % DH changed so that interpretation of G's is: [g_ee g_ii g_ei g_ie g_se]
end
