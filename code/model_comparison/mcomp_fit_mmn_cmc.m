...
switch uid(1: end-1)
    ...
    otherwise
        ...
        presults = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/mmn/model_comparison/dcms';
        pdata    = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/mmn/model_comparison/data';
