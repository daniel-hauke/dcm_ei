...
#$ -N mmn_mrec
#$ -t 1-1
#$ -o /SAN/intelsys/Psycho_Pheno2/dcm_ei/results/mmn/model_comparison/logfiles
#$ -e /SAN/intelsys/Psycho_Pheno2/dcm_ei/results/mmn/model_comparison/errorfiles
...
matlab -nodisplay -nodesktop -nojvm -nosplash -singleCompThread -r "mcomp_reinvert_cluster(${SGE_TASK_ID},'MMN')" 
