...
switch uid(1: end-1)
    ...
    otherwise
        ...
        presults = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/p50/model_comparison/dcms';
        pdata = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/p50/model_comparison/data';
