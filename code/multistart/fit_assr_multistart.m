function fit_assr_multistart(vbsv,rerun)
...
switch uid(1: end-1)
    ...
    case 'laptop-0jhjt7kf\danie'
        pvbsv = 'C:\projects\dcm_ei_sim\results\P300_grandmean_v5\multistart\erp_vbsv_grisearch_tau_and_s';
    ...
    % Cluster
    otherwise
        pvbsv = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/multistart/vbsvs_tau_s_6_sources_csd';
        frerun =  '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/assr/multistart/vbsvs_to_rerun.mat';
        presults = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/assr/multistart/dcms';
        pdata = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/data/assr/mean_S001_sensordata_spm.mat';
...
dcm_fname = fullfile(presults, ['dcm_assr_cmc_ei_v1_vbsv' num2str(vbsv) '.mat']);
...
job{1}.spm.meeg.source.headmodel.coregistration.coregspecify.fiducial(1).fidname = 'NZ';
job{1}.spm.meeg.source.headmodel.coregistration.coregspecify.fiducial(1).specification.select = 'nas';
job{1}.spm.meeg.source.headmodel.coregistration.coregspecify.fiducial(2).fidname = 'L';
job{1}.spm.meeg.source.headmodel.coregistration.coregspecify.fiducial(2).specification.select = 'lpa';
job{1}.spm.meeg.source.headmodel.coregistration.coregspecify.fiducial(3).fidname = 'R';
...
DCM.options.Tdcm(1)  = 250;           % start of peri-stimulus time to be modelled
...
% Sources
DCM.Sname = {'lTHA', 'rTHA', 'lA1', 'rA1', 'lHIP', 'rHIP'};
DCM.Lpos  = [-16 -30 -6;    % left MGN
    16 -30 -6;    % right
    -58 -16 14;    % left A1
    58 -16 14;    % right
    -24 -16 -30;   % left Hip
