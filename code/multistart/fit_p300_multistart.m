function fit_p300_multistart(vbsv,rerun)
...
switch uid(1: end-1)
    ...
    otherwise
        ...
        frerun =  '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/p300/multistart/vbsvs_to_rerun.mat';
        presults = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/p300/multistart/dcms';
        pdata = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/data/p300/p300_grandmean_hc_f15.mat';
...
dcm_fname = fullfile(presults, ['dcm_p300_cmc_ei_v1_vbsv' num2str(vbsv) '.mat']);
