...
#$ -N assr
#$ -t 2-2501
#$ -o /SAN/intelsys/Psycho_Pheno2/dcm_ei/results/assr/multistart/logfiles
#$ -e /SAN/intelsys/Psycho_Pheno2/dcm_ei/results/assr/multistart/errorfiles
...
echo "Execute command: fit_assr_multistart(${SGE_TASK_ID},0)" 
matlab -nodisplay -nodesktop -nojvm -nosplash -singleCompThread -r "fit_assr_multistart(${SGE_TASK_ID},0)" 
