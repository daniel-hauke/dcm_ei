function fit_mmn_multistart(vbsv,rerun)
...
switch uid(1: end-1)
    ...
    case 'laptop-0jhjt7kf\danie'
        ...
        frerun =  'F:\NAPLS2\results\P300\P300_grandmean_with_multistart_svs_as_priors_v1\vbsvs_to_rerun.mat';
        presults = 'C:\projects\dcm_ei_sim\results\NAPLS\P300\P300_grandmean_with_multistart_v1\dcms';
        pdata = 'C:\projects\dcm_ei_sim\data\NAPLS\p300_grandmean_all_f15.mat';
        pcode = 'C:\projects\dcm_ei_sim\code';
        
    case 'rickadams'
        pvbsv = '/Volumes/RAdams16TB/Data/NAPLS2/P300_grandmean/multistart_10xpC/vbsv';
    ...
    otherwise
        ...
        frerun =  '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/mmn/multistart/vbsvs_to_rerun.mat';
        presults = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/mmn/multistart/dcms';
        pdata = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/data/mmn/napls_mmn_grandmean_hc.mat';
...
dcm_fname = fullfile(presults, ['dcm_mmn_cmc_ei_v1_vbsv' num2str(vbsv) '.mat']);
