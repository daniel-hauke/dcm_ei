function precov_fit_p50_rlx_glo(s)
...
switch uid(1: end-1)
    ...
    % Cluster
    otherwise
        pdcm   = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/p50/dcm/dcm_p50_cmc_ei_v1.mat';
        presults = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/p50/param_recov_rlx_glo/dcms';
        pdata = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/p50/param_recov_rlx_glo/data';
...
dcm_fname = fullfile(presults, [id '_dcm_p50_cmc_ei_v1.mat']);
