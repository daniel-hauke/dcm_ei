function precov_reinvert_cluster_rlx_glo(s,data)
%--------------------------------------------------------------------------
...
switch data
    case 'P50'
        root = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/p50/param_recov_rlx_glo/estimated';
    case 'P300'
        root = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/p300/param_recov_rlx_glo/estimated';
    case 'MMN'
        root =  '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/mmn/param_recov_rlx_glo/estimated';
end
