...
#$ -N p300_rec
#$ -t 1-1
#$ -o /SAN/intelsys/Psycho_Pheno2/dcm_ei/results/p300/param_recov_rlx_glo/logfiles
#$ -e /SAN/intelsys/Psycho_Pheno2/dcm_ei/results/p300/param_recov_rlx_glo/errorfiles
...
echo "Execute command: precov_reinvert_cluster_rlx_glo(${SGE_TASK_ID},'P300')" 
matlab -nodisplay -nodesktop -nojvm -nosplash -singleCompThread -r "precov_reinvert_cluster_rlx_glo(${SGE_TASK_ID},'P300')" 
