...
echo "Execute command: precov_fit_mmn_rlx_glo(${SGE_TASK_ID})" 
matlab -nodisplay -nodesktop -nojvm -nosplash -singleCompThread -r "precov_fit_mmn_rlx_glo(${SGE_TASK_ID})" 
