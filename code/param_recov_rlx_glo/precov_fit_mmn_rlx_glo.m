function precov_fit_mmn_rlx_glo(s)
...
switch uid(1: end-1)
    ...
    case 'laptop-0jhjt7kf\danie'
        presults = 'C:\projects\dcm_ei_sim\results\NAPLS\P300\P300_grandmean_with_multistart_v1\dcms';
        pdata = 'C:\projects\dcm_ei\results\mmn\parameter_recovery\dcm';
    ...
    case 'rickadams'
        presults = '/Volumes/RAdams16TB/Data/NAPLS2/P300_grandmean/multistart_10xpC/dcms';
        pdata = '/Volumes/RAdams16TB/Data/NAPLS2/P300_grandmean/p300_grandmean_all_f15.mat';
        pcode = '/Users/rickadams/Code/dcm_ei_sim/code';

        % Cluster
    otherwise
        pdcm   = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/mmn/dcm/dcm_mmn_cmc_ei_v1.mat';
        presults = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/mmn/param_recov_rlx_glo/dcms';
        pdata    = '/SAN/intelsys/Psycho_Pheno2/dcm_ei/results/mmn/param_recov_rlx_glo/data';
...
dcm_fname = fullfile(presults, [id '_dcm_mmn_cmc_ei_v1.mat']);
...
DCM.M.pE.B_g_ee = repmat(DCM.M.pE.B_g_ee,numel(DCM.Sname),1);
DCM.M.pE.B_g_ii = repmat(DCM.M.pE.B_g_ii,numel(DCM.Sname),1);
DCM.M.pC.B_g_ee = repmat(DCM.M.pC.B_g_ee,numel(DCM.Sname),1);
DCM.M.pC.B_g_ii = repmat(DCM.M.pC.B_g_ii,numel(DCM.Sname),1);
