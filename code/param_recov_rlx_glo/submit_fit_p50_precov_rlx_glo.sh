...
echo "Execute command: precov_fit_p50_rlx_glo(${SGE_TASK_ID})" 
matlab -nodisplay -nodesktop -nojvm -nosplash -singleCompThread -r "precov_fit_p50_rlx_glo(${SGE_TASK_ID})" 
