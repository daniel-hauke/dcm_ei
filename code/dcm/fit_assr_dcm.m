...
opt.dcm_prefix = 'dcm_assr_cmc_ei';  % prefix of dcm file (model and version will be appended)
...
if opt.run_dcm
   ...
   % DCM options
    ...
    DCM.options.Fdcm     = [15 48];     % frequency band to be modelled (default = 4-48 Hz)
